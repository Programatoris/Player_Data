    ...
    <main>
        ...
        <div class="download-buttons">
            <div class="download-button-container">
                <img src="./img/windows.png" alt="Windows Icon">
                <a href="#" class="download-button">Download for Windows</a>
            </div>
            <div class="download-button-container">
                <img src="./img/mac.png" alt="macOS Icon">
        ...
        <div class="download-buttons2">
            <div class="download-button-container">
                <img src="./img/app store.png" alt="macOS Icon">
                <a href="https://www.apple.com/app-store/" class="download-button">Download on App Store</a>
            </div>
            <div class="download-button-container">
                <img src="./img/google play.png" alt="Linux Icon">
                <a href="https://play.google.com/store/games?device=windows&pli=1" class="download-button">Download on Google Play</a>
            </div>
        </div>
    </main>
