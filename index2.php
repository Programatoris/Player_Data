...
<body>
    ...
    <header>
        ...
        <div class="navbar">
            ...
            <div class="dropdown-content">
                ...
                <a href="./Index.html" id="logout-link" onclick="showLogoutPopup()">Log out</a>
            </div>
        ...
        <img src="./img/pfp.jpg" alt="Image not found" class="pfp">
    </header>
    ...
    <article id="yellow" class="allign">
        ...
        <a href="#download" class="download-button" id="download">Download Now</a>
    </article>
